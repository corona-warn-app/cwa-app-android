...
class QrCodeDetailFragmentTest : BaseUITest() {
    ...
    fun eventDetailForSameDatesTest() {
        ...
        onView(withId(R.id.tl_organizer_title)).check(matches(withText("Jahrestreffen der deutschen SAP Anwendergruppe")))
        onView(withId(R.id.tl_organizer_subtitle)).check(matches(withText("Hauptstr. 3, 69115 Heidelberg")))
    ...
    fun eventDetailForDifferentDatesTest() {
        ...
        onView(withId(R.id.tl_organizer_title)).check(matches(withText("Event XYZ")))
        onView(withId(R.id.tl_organizer_subtitle)).check(matches(withText("Otto-Hahn-Str. 3, 123456 Berlin")))
