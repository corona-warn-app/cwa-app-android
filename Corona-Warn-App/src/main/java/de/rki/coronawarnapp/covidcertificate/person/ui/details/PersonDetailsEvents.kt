...
data class OpenBoosterInfoDetails(val personCode: String) : PersonDetailsEvents()
data class OpenCertificateReissuanceConsent(val personCode: String) : PersonDetailsEvents()
