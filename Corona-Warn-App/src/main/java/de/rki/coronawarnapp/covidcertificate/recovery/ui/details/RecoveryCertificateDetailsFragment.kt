...
@AndroidEntryPoint
class RecoveryCertificateDetailsFragment : Fragment(R.layout.fragment_recovery_certificate_details) {

    @Inject lateinit var factory: RecoveryCertificateDetailsViewModel.Factory
    ...
    private val viewModel: RecoveryCertificateDetailsViewModel by assistedViewModel {
        factory.create(
