...
class ProfileQrCodeFragmentViewModel @AssistedInject constructor(
    ...
    @AssistedFactory
    interface Factory : CWAViewModelFactory<ProfileQrCodeFragmentViewModel> {
        fun create(profileId: ProfileId): ProfileQrCodeFragmentViewModel
    }
}
