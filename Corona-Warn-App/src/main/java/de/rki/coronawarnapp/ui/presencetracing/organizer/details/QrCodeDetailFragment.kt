...
class QrCodeDetailFragment : Fragment(R.layout.trace_location_organizer_qr_code_detail_fragment), AutoInject {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            appBarLayout.onOffsetChange { titleAlpha, subtitleAlpha ->
                tlOrganizerTitle.alpha = titleAlpha
                tlOrganizerSubtitle.alpha = subtitleAlpha
        ...
        viewModel.uiState.observe2(this) { uiState ->
            with(binding) {
                tlOrganizerTitle.text = uiState.description
                tlOrganizerSubtitle.text = uiState.address
    ...
    private fun setToolbarOverlay() {
        ...
        val textParams = binding.tlOrganizerSubtitle.layoutParams as (LinearLayout.LayoutParams)
        textParams.bottomMargin = ((width) / 2) - 24 /* 24 is space between screen border and QrCode */
        binding.tlOrganizerSubtitle.requestLayout() /* 24 is space between screen border and QrCode */
