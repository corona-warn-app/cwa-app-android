...
class CrashReporterAdapter : RecyclerView.Adapter<CrashReporterAdapter.CrashHolder>() {
    ...
    class CrashHolder(private val binding: ViewCrashreportListItemBinding) : RecyclerView.ViewHolder(binding.root) {
