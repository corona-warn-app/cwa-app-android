...
fun Fragment.removeAllItemsDialog(positiveButtonAction: () -> Unit) = createDialog {
...
fun Fragment.recycleCertificateDialog(positiveButtonAction: () -> Unit) = createDialog {
...
fun Fragment.recycleTestDialog(positiveButtonAction: () -> Unit) = createDialog {
...
fun Fragment.restoreCertificateDialog(positiveButtonAction: () -> Unit) = createDialog {
...
fun Fragment.restoreTestDialog(positiveButtonAction: () -> Unit) = createDialog {
