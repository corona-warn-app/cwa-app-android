...
object RiskScoreParameterService {
    ...
    private fun ApplicationConfigurationOuterClass.ApplicationConfiguration.configValues(): Pair<RiskScoreParameters, Int> =
        Pair(this.exposureConfig, this.minRiskScore)
    ...
    private fun Pair<RiskScoreParameters, Int>.mapRiskScoreToExposureConfiguration(): ExposureConfiguration =
