...
import de.rki.coronawarnapp.eventregistration.storage.retention.TraceLocationCleanUpWorker
...
abstract class WorkerBinder {
    ...
    @Binds
    @IntoMap
    @WorkerKey(TraceLocationCleanUpWorker::class)
    abstract fun traceLocationCleanUpWorker(
        factory: TraceLocationCleanUpWorker.Factory
    ): InjectedWorkerFactory<out ListenableWorker>
}
