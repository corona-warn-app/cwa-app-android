...
object LocalData {
     ...
     * @return boolean if user is onboarded
     */
    fun isContactDiaryOnboarded(): Boolean = getSharedPreferenceInstance().getBoolean(
        CoronaWarnApplication.getAppContext().getString(R.string.preference_onboarding_contact_diary_completed),
        false
    )
     ...
     * @param value boolean if onboarding was completed
     */
    fun isContactDiaryOnboarded(value: Boolean) = getSharedPreferenceInstance().edit(true) {
        putBoolean(
            CoronaWarnApplication.getAppContext()
                .getString(R.string.preference_onboarding_contact_diary_completed), value
        )
    }
     ...
     * @return
     */
    fun onboardingContactDiaryCompletedTimestamp(): Long? {
        val timestamp = getSharedPreferenceInstance().getLong(
            CoronaWarnApplication.getAppContext()
                .getString(R.string.preference_onboarding_contact_diary_completed_timestamp), 0L
        )
     ...
     * @param value
     */
    fun onboardingContactDiaryCompletedTimestamp(value: Long) = getSharedPreferenceInstance().edit(true) {
        putLong(
            CoronaWarnApplication.getAppContext()
                .getString(R.string.preference_onboarding_contact_diary_completed_timestamp), value
        )
    }
