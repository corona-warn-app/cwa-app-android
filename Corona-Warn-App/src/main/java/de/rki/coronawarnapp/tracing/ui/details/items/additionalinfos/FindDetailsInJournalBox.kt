...
class FindDetailsInJournalBox(
    ...
    data class Item(
        ...
        fun getText(context: Context): String = if (riskState == RiskState.INCREASED_RISK)
            context.getString(R.string.risk_details_find_details_in_journal_increased_risk)
        else
            context.getString(R.string.risk_details_find_details_in_journal)
    }
}
