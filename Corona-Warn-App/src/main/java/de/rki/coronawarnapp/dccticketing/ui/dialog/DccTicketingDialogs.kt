...
fun Fragment.dccTicketingConfirmCancellationDialog(negativeButtonAction: () -> Unit) = createDialog {
...
fun Fragment.dccTicketingErrorDialog(message: String) = createDialog {
