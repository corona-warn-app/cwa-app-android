...
class DccTicketingSubmissionHandler @Inject constructor(
    ...
    suspend fun submit(transactionContext: DccTicketingTransactionContext): DccTicketingTransactionContext {
        val encryptionParameters = transactionContext.getEncryptionParameters()
        val signedOutput = securityTool.encryptAndSign(transactionContext.getSecurityToolInput(encryptionParameters))
