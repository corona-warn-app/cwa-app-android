...
class DccTicketingException(
    ...
    val errorMessage: LazyString
        get() = CachedString { context ->
            when (errorCode) {
                ErrorCode.VD_ID_CLIENT_ERR -> TODO()
                ErrorCode.AES_CBC_INVALID_IV -> TODO()
                ErrorCode.AES_CBC_INVALID_KEY -> TODO()
                ErrorCode.AES_CBC_NOT_SUPPORTED -> TODO()
                ErrorCode.AES_GCM_INVALID_IV -> TODO()
                ErrorCode.AES_GCM_INVALID_KEY -> TODO()
                ErrorCode.AES_GCM_NOT_SUPPORTED -> TODO()
                ErrorCode.ATR_AUD_INVALID -> TODO()
                ErrorCode.ATR_CERT_PIN_MISMATCH -> TODO()
                ErrorCode.ATR_CERT_PIN_NO_JWK_FOR_KID -> TODO()
                ErrorCode.ATR_CLIENT_ERR -> TODO()
                ErrorCode.ATR_JWT_VER_ALG_NOT_SUPPORTED -> TODO()
                ErrorCode.ATR_JWT_VER_EMPTY_JWKS -> TODO()
                ErrorCode.ATR_JWT_VER_NO_JWK_FOR_KID -> TODO()
                ErrorCode.ATR_JWT_VER_NO_KID -> TODO()
                ErrorCode.ATR_JWT_VER_SIG_INVALID -> TODO()
                ErrorCode.ATR_NO_NETWORK -> TODO()
                ErrorCode.ATR_PARSE_ERR -> TODO()
                ErrorCode.ATR_SERVER_ERR -> TODO()
                ErrorCode.ATR_TYPE_INVALID -> TODO()
                ErrorCode.EC_SIGN_INVALID_KEY -> TODO()
                ErrorCode.EC_SIGN_NOT_SUPPORTED -> TODO()
                ErrorCode.INIT_DATA_PARSE_ERR -> TODO()
                ErrorCode.INIT_DATA_PROTOCOL_INVALID -> TODO()
                ErrorCode.INIT_DATA_SUBJECT_EMPTY -> TODO()
                ErrorCode.INIT_DATA_SP_EMPTY -> TODO()
                ErrorCode.RSA_ENC_INVALID_KEY -> TODO()
                ErrorCode.RSA_ENC_NOT_SUPPORTED -> TODO()
                ErrorCode.RTR_CERT_PIN_MISMATCH -> TODO()
                ErrorCode.RTR_CERT_PIN_NO_JWK_FOR_KID -> TODO()
                ErrorCode.RTR_CLIENT_ERR -> TODO()
                ErrorCode.RTR_JWT_VER_ALG_NOT_SUPPORTED -> TODO()
                ErrorCode.RTR_JWT_VER_EMPTY_JWKS -> TODO()
                ErrorCode.RTR_JWT_VER_NO_JWK_FOR_KID -> TODO()
                ErrorCode.RTR_JWT_VER_NO_KID -> TODO()
                ErrorCode.RTR_JWT_VER_SIG_INVALID -> TODO()
                ErrorCode.RTR_NO_NETWORK -> TODO()
                ErrorCode.RTR_SERVER_ERR -> TODO()
                ErrorCode.VD_ID_NO_ATS_SIGN_KEY -> TODO()
                ErrorCode.VD_ID_NO_ATS_SVC_KEY -> TODO()
                ErrorCode.VD_ID_NO_ATS -> TODO()
                ErrorCode.VD_ID_NO_NETWORK -> TODO()
                ErrorCode.VD_ID_NO_VS_SVC_KEY -> TODO()
                ErrorCode.VD_ID_NO_VS -> TODO()
                ErrorCode.VD_ID_PARSE_ERR -> TODO()
                ErrorCode.VD_ID_SERVER_ERR -> TODO()
                ErrorCode.VS_ID_CERT_PIN_MISMATCH -> TODO()
                ErrorCode.VS_ID_CERT_PIN_NO_JWK_FOR_KID -> TODO()
                ErrorCode.VS_ID_CLIENT_ERR -> TODO()
                ErrorCode.VS_ID_NO_ENC_KEY -> TODO()
                ErrorCode.VS_ID_NO_NETWORK -> TODO()
                ErrorCode.VS_ID_NO_SIGN_KEY -> TODO()
                ErrorCode.VS_ID_PARSE_ERR -> TODO()
                ErrorCode.VS_ID_SERVER_ERR -> TODO()
