...
class CheckInsTransformerTest : BaseTest() {
    ...
    private val checkIn2 = CheckIn(
        ...
        traceLocationEnd = null,
        defaultCheckInLengthInMinutes = null,
        traceLocationBytes = TRACE_LOCATION_2.toByteString(),
        signature = "c2lnbmF0dXJlMQ==".decodeBase64()!!,
    ...
    private val checkIn3 = CheckIn(
        ...
        traceLocationBytes = TRACE_LOCATION_3.toByteString(),
        signature = "c2lnbmF0dXJlMQ==".decodeBase64()!!,
    ...
    companion object {
        ...
        private val TRACE_LOCATION_2 = byteArrayOf(
            10,
            16,
            116,
            114,
        ...
        private val TRACE_LOCATION_3 = byteArrayOf(
            10,
            16,
            116,
            114,
