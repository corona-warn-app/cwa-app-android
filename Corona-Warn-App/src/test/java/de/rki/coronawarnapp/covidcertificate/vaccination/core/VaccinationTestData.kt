...
class VaccinationTestData @Inject constructor(
    ...
    companion object {
        const val personAVac1QRCodeString =
        ...
        const val personAVac2QRCodeString =
        ...
        const val personYVacTwoEntriesQrCode =
        ...
        // BorisJohnson1.pdf
        const val personBVac1QRCodeString =
        ...
        val personAVac2CertificateData = DccData(
            ...
            certificateJson = """{"v":[{"ci":"01DE/00001/1119305005/6IPYBAIDWEWRWW73QEP92FQSN#S","co":"DE","dn":2,"dt":"2021-04-27","is":"Bundesministerium für Gesundheit - Test01","ma":"ORG-100001699","mp":"EU/1/21/1529","sd":2,"tg":"840539006","vp":"1119305005"}],"dob":"1966-11-11","nam":{"fn":"Astrá Eins","gn":"Andreas","fnt":"ASTRA<EINS","gnt":"ANDREAS"},"ver":"1.0.0"}""",
            kid = "qs76QaMRQrC+bjTS2a3mSA==",
            dscMessage = DscMessage(
                protectedHeader = "a10126".decodeBase64()!!,
                signature = "399ae5e1819909acc692a717d60072fbc6a5bd3dd5dfa02e8c2ad4a0a9ab374dc8a09e6c4c6d07e444245bfd946fc696dd27d973a1828e29e8f845b344d63917".decodeBase64()!!,
                kid = "qs76QaMRQrC+bjTS2a3mSA==",
                algorithm = DscMessage.Algorithm.ES256,
                payload = EMPTY
            ),
