...
class VaccinationTestData @Inject constructor(
    ...
    private val personAVac1CertificateHeader = DccHeader(
        issuer = "DE",
    ...
    private val personAVac1CertificateData = DccData(
        ...
        coseObject = "".decodeBase64()!!
            .toByteArray()
    )
    ...
    private val personAVac2CertificateHeader = DccHeader(
        issuer = "DE",
    ...
    private val personBVac1CertificateHeader = DccHeader(
        issuer = "DE",
    ...
    private val personBVac1CertificateData = DccData(
        ...
        kid = "qs76QaMRQrC+bjTS2a3mSA==",
        coseObject = "".decodeBase64()!!
            .toByteArray()
    )
