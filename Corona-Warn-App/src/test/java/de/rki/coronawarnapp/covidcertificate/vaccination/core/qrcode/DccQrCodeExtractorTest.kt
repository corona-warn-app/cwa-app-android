...
class DccQrCodeExtractorTest : BaseTest() {
    ...
    fun `happy path extraction with data`() {
        ...
        with(qrCode.data.certificate) {
            ...
            with(vaccination) {
                ...
                vaccinatedAtFormatted shouldBe LocalDate.parse("2021-02-18")
            }
        }
    }
    ...
    fun `Bulgarian qr code passes`() {
        ...
        with(qrCode.data.certificate) {
            ...
            dateOfBirthFormatted shouldBe LocalDate.parse("1978-01-26")
            version shouldBe "1.0.0"
            ...
            vaccination.apply {
                ...
                vaccinatedAtFormatted shouldBe LocalDate.parse("2021-03-09")
            }
        }
    }
    ...
    fun `pass german reference case`() {
        extractor.extract(
            ...
            data.certificate.dateOfBirthFormatted shouldBe LocalDate.parse("1964-08-12")
            data.certificate.vaccination.vaccinatedAtFormatted shouldBe LocalDate.parse("2021-05-29")
        }
    }
    ...
    fun `pass vaccination and dob with time at midnight`() {
        extractor.extract(
            ...
            this as VaccinationCertificateQRCode
            data.certificate.dateOfBirthFormatted shouldBe LocalDate.parse("1978-01-26")
            data.certificate.vaccination.vaccinatedAtFormatted shouldBe LocalDate.parse("2021-03-09")
        }
    }
    ...
    fun `pass vaccination date with full timestamp`() {
        extractor.extract(
            ...
            this as VaccinationCertificateQRCode
            data.certificate.dateOfBirthFormatted shouldBe LocalDate.parse("1958-11-11")
            data.certificate.vaccination.vaccinatedAtFormatted shouldBe LocalDate.parse("2021-03-18")
        }
    }
