...
class OverlapTest : BaseTest() {
    ...
    fun `test helper method createCheckIn`() {
        val checkIn = createCheckIn(
            ...
            startDateStr = "2021-03-04T09:30:00Z",
            endDateStr = "2021-03-04T09:45:00Z"
        )
    ...
    fun `returns null if check-in is preceded by warning`() {
        createCheckIn(
            traceLocationId = locationId,
            startDateStr = "2021-03-04T11:15:00Z",
            endDateStr = "2021-03-04T11:20:00Z"
        ).calculateOverlap(
            createWarning(
                traceLocationId = locationId,
                startIntervalDateStr = "2021-03-04T10:00:00Z",
    ...
    fun `returns null if check-in meets warning at the start`() {
        createCheckIn(
            traceLocationId = locationId,
            startDateStr = "2021-03-04T09:30:00Z",
            endDateStr = "2021-03-04T10:00:00Z"
        ).calculateOverlap(
            createWarning(
                traceLocationId = locationId,
                startIntervalDateStr = "2021-03-04T10:00:00Z",
    ...
    fun `returns null if check-in meets warning at the end`() {
        createCheckIn(
            traceLocationId = locationId,
            startDateStr = "2021-03-04T11:00:00Z",
            endDateStr = "2021-03-04T11:10:00Z"
        ).calculateOverlap(
            createWarning(
                traceLocationId = locationId,
                startIntervalDateStr = "2021-03-04T10:00:00Z",
    ...
    fun `returns overlap if check-in overlaps warning at the end`() {
        createCheckIn(
            traceLocationId = locationId,
            startDateStr = "2021-03-04T10:45:00Z",
            endDateStr = "2021-03-04T11:12:00Z"
        ).calculateOverlap(
            createWarning(
                traceLocationId = locationId,
                startIntervalDateStr = "2021-03-04T10:00:00Z",
    ...
    fun `returns overlap if check-in starts warning`() {
        createCheckIn(
            traceLocationId = locationId,
            startDateStr = "2021-03-04T10:00:00Z",
            endDateStr = "2021-03-04T10:13:00Z"
        ).calculateOverlap(
            createWarning(
                traceLocationId = locationId,
                startIntervalDateStr = "2021-03-04T10:00:00Z",
    ...
    fun `returns overlap if check-in finishes warning`() {
        createCheckIn(
            traceLocationId = locationId,
            startDateStr = "2021-03-04T10:30:00Z",
            endDateStr = "2021-03-04T11:00:00Z"
        ).calculateOverlap(
            createWarning(
                traceLocationId = locationId,
                startIntervalDateStr = "2021-03-04T10:00:00Z",
    ...
    fun `returns overlap after rounding (up)`() {
        createCheckIn(
            traceLocationId = locationId,
            startDateStr = "2021-03-04T09:50:00Z",
            endDateStr = "2021-03-04T10:05:45Z"
        ).calculateOverlap(
            createWarning(
                traceLocationId = locationId,
                startIntervalDateStr = "2021-03-04T10:00:00Z",
    ...
    fun `returns overlap after rounding (down)`() {
        createCheckIn(
            traceLocationId = locationId,
            startDateStr = "2021-03-04T09:50:00Z",
            endDateStr = "2021-03-04T10:05:15Z"
        ).calculateOverlap(
            createWarning(
                traceLocationId = locationId,
                startIntervalDateStr = "2021-03-04T10:00:00Z",
