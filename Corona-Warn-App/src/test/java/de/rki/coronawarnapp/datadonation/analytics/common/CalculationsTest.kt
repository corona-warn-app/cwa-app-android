...
class CalculationsTest : BaseTest() {
    ...
    fun `getLastChangeToHighRiskPt works`() {
        val ptRisk0 = PtRiskLevelResult(
            calculatedAt = LocalDate.of(2021, 3, 19).toDateTimeAtStartOfDay().toInstant(),
            riskState = RiskState.LOW_RISK,
            calculatedFrom = LocalDate.of(2021, 3, 5).toDateTimeAtStartOfDay().toInstant()
        )
        val ptRisk1 = PtRiskLevelResult(
            calculatedAt = LocalDate.of(2021, 3, 20).toDateTimeAtStartOfDay().toInstant(),
            riskState = RiskState.INCREASED_RISK,
            calculatedFrom = LocalDate.of(2021, 3, 6).toDateTimeAtStartOfDay().toInstant()
        )
        val ptRisk2 = PtRiskLevelResult(
            calculatedAt = LocalDate.of(2021, 3, 21).toDateTimeAtStartOfDay().toInstant(),
            riskState = RiskState.LOW_RISK,
            calculatedFrom = LocalDate.of(2021, 3, 7).toDateTimeAtStartOfDay().toInstant()
        )
        val ptRisk3 = PtRiskLevelResult(
            calculatedAt = LocalDate.of(2021, 3, 22).toDateTimeAtStartOfDay().toInstant(),
            riskState = RiskState.INCREASED_RISK,
            calculatedFrom = LocalDate.of(2021, 3, 8).toDateTimeAtStartOfDay().toInstant()
        )
        val ptRisk4 = PtRiskLevelResult(
            calculatedAt = LocalDate.of(2021, 3, 23).toDateTimeAtStartOfDay().toInstant(),
            riskState = RiskState.CALCULATION_FAILED,
            calculatedFrom = LocalDate.of(2021, 3, 9).toDateTimeAtStartOfDay().toInstant()
        )
        val ptRisk5 = PtRiskLevelResult(
            calculatedAt = LocalDate.of(2021, 3, 24).toDateTimeAtStartOfDay().toInstant(),
            riskState = RiskState.INCREASED_RISK,
            calculatedFrom = LocalDate.of(2021, 3, 10).toDateTimeAtStartOfDay().toInstant()
        )
        val registeredAt = LocalDate.of(2021, 3, 24).toDateTimeAtStartOfDay().toInstant()
        listOf(
            ptRisk0,
            ptRisk1,
            ptRisk2,
            ...
            LocalDate.of(2021, 3, 22).toDateTimeAtStartOfDay().toInstant()
    }
    ...
    fun `getLastChangeToHighRiskPt works 2`() {
        ...
        val registeredAt = LocalDate.of(2021, 3, 21).toDateTimeAtStartOfDay().toInstant()
        listOf(
            ptRisk0,
            ptRisk1,
            ptRisk2,
            ...
            LocalDate.of(2021, 3, 20).toDateTimeAtStartOfDay().toInstant()
    }
    ...
    fun `getLastChangeToHighRiskPt works 3`() {
        ...
        val registeredAt = LocalDate.of(2021, 3, 23).toDateTimeAtStartOfDay().toInstant()
        listOf(
            ptRisk0,
            ptRisk1,
            ptRisk2,
    ...
    fun `getLastChangeToHighRiskPt works 7`() {
        ...
        val registeredAt = LocalDate.of(2021, 3, 23).toDateTimeAtStartOfDay().toInstant()
        listOf(ptRisk0).getLastChangeToHighPtRiskBefore(registeredAt) shouldBe
            LocalDate.of(2021, 3, 19).toDateTimeAtStartOfDay().toInstant()
    }
