...
class DaySyncToolTest : BaseIOTest() {
    ...
    @Test
    fun `determine missing days`() {
        TODO("determineMissingDays")
    }

    @Test
    fun `missing days data is used to create cache entries and launch downloads`() {
        TODO()
    }

    @Test
    fun `app config can invalidate cached days`() {
        TODO()
    }
