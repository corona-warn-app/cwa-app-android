...
class RiskLevelTest {
    ...
    fun testEnum() {
        ...
        assertEquals(
            RiskLevel.UNKNOWN_RISK_OUTDATED_RESULTS.raw,
    ...
    fun testForValue() {
        assertEquals(
            RiskLevel.forValue(RiskLevelConstants.UNKNOWN_RISK_INITIAL),
        ...
        assertEquals(
            RiskLevel.forValue(RiskLevelConstants.LOW_LEVEL_RISK),
            RiskLevel.LOW_LEVEL_RISK
        )
        assertEquals(
            RiskLevel.forValue(RiskLevelConstants.INCREASED_RISK),
