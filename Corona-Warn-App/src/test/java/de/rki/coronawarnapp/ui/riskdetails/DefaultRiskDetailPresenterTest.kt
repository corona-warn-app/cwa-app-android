...
class DefaultRiskDetailPresenterTest {
    ...
    fun test_isAdditionalInfoVisible() {
        DefaultRiskDetailPresenter().apply {
            isAdditionalInfoVisible(LOW_LEVEL_RISK, 0) shouldBe false
            isAdditionalInfoVisible(LOW_LEVEL_RISK, 1) shouldBe true
    ...
    fun test_isInformationBodyNoticeVisible() {
        DefaultRiskDetailPresenter().apply {
            isInformationBodyNoticeVisible(LOW_LEVEL_RISK) shouldBe false
