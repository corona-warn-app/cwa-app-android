...
abstract class MainActivityTestModule {
    ...
    @ContributesAndroidInjector(modules = [TraceLocationOrganiserQrCodesListTestFragmentModule::class])
    abstract fun organiserQrCodesList(): TraceLocationOrganiserQrCodesListTestFragment
