...
-keep class de.rki.coronawarnapp.appconfig.internal.** { *; }
-keep class de.rki.coronawarnapp.bugreporting.debuglog.upload.history.model.** { *; }
-keep class de.rki.coronawarnapp.bugreporting.debuglog.upload.server.** { *; }
...
-keep class de.rki.coronawarnapp.contactdiary.storage.entity.** { *; }
...
-keep class de.rki.coronawarnapp.covidcertificate.recovery.core.storage.** { *; }
-keep class de.rki.coronawarnapp.covidcertificate.revocation.model.** { *; }
-keep class de.rki.coronawarnapp.covidcertificate.test.core.server.** { *; }
-keep class de.rki.coronawarnapp.covidcertificate.test.core.storage.types.** { *; }
...
-keep class de.rki.coronawarnapp.dccreissuance.core.server.data.** { *; }
-keep class de.rki.coronawarnapp.dccticketing.core.** { *; }
...
-keep class de.rki.coronawarnapp.profile.legacy.** { *; }
-keep class de.rki.coronawarnapp.srs.core.model.** { *; }
-keep class de.rki.coronawarnapp.statistics.local.storage.** { *; }
-keep class de.rki.coronawarnapp.storage.** { *; }
